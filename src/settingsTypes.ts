...
export interface ShreeSettings {
  ...
  wake_word_enabled: boolean; wake_phrases: string[]; background_listening: boolean; auto_sleep_enabled:boolean; auto_sleep_timeout_seconds:number;
...
export const defaultSettings:ShreeSettings = {
  ...
  wake_word_enabled:false,wake_phrases:["Hello Shree","Hi Shree","Hey Shree","Namaste Shree","Shree"],background_listening:false,auto_sleep_enabled:true,auto_sleep_timeout_seconds:15,
