...
export interface ShreeSettings {
  ...
  wake_word_enabled: boolean; wake_phrases: string[]; background_listening: boolean; wake_foreground_on_detection:boolean; auto_sleep_enabled:boolean; auto_sleep_timeout_seconds:number;
  reasoning_enabled: boolean; tool_use_enabled: boolean; web_search_enabled:boolean; memory_enabled: boolean; code_execution_enabled: boolean; screen_understanding_enabled: boolean; desktop_control_enabled: boolean; assistant_voice:"Achernar"|"Vindemiatrix"|"Leda"|"Aoede"|"Kore"; v1_1_20_voice_restored:boolean; soft_voice_migrated:boolean;
...
export const defaultSettings:ShreeSettings = {
  ...
  wake_word_enabled:false,wake_phrases:["Hello Shree","Hi Shree","Hey Shree","Namaste Shree","Shree"],background_listening:false,wake_foreground_on_detection:true,auto_sleep_enabled:true,auto_sleep_timeout_seconds:15,
  reasoning_enabled:true,tool_use_enabled:true,web_search_enabled:true,memory_enabled:true,code_execution_enabled:false,screen_understanding_enabled:true,desktop_control_enabled:true,assistant_voice:"Achernar",v1_1_20_voice_restored:true,soft_voice_migrated:true,
